...
const ParentDashboard = ({ user, onLogout }) => {
  ...
  if (!dashboardData) {
    return <div className="min-h-screen bg-muted/40 flex justify-center items-center"><p>Şagird məlumatları yüklənə bilmədi.</p></div>;
  }
      ...
      <div className="min-h-screen w-full bg-muted/40">
        <header className="h-16 bg-card border-b sticky top-0 z-30">
            <div className="h-full px-4 sm:px-6 flex items-center justify-between max-w-7xl mx-auto">
                <h1 className="text-xl font-bold text-foreground">Valideyn Paneli</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 flex flex-col gap-8">
                <Card className="flex-grow flex flex-col">
                    <CardHeader><CardTitle>Son Nəticələr</CardTitle></CardHeader>
